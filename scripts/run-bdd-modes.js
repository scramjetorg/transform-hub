...
// Node runner without admitting the known slow, exclusive, memory-remediation,
// or functionally blocked groups into the ordinary command.
const BASE_CHUNKS = Object.freeze(["verser2", "topics-api", "appcontext", "node"]);
