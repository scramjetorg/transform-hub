...
- [x] **Track: Platform CLI over Verser2: enable mTLS-authenticated CLI access to MultiManager, Manager, and Hub APIs; inventory and design command structure with a user-review pause; support arbitrary API calls; phase v1 translation before native v2 CLI coverage.**
