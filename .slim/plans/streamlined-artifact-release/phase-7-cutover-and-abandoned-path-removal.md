# Phase 7 — Cutover and Abandoned-Path Removal
...
- [ ] Remove only after Phase 4–6 evidence and remote protection changes are confirmed:
...
- [ ] Remove pre-publication OCI image build/staging paths from candidate workflows; Phase 8 owns OCI creation from finalized published packages only.
...
- The new path completes a rehearsal without invoking transformed prerelease, directory publication, or candidate-time OCI build code.
