# `@scramjet/types` <!-- omit in toc -->

This package is part of [Scramjet Transform Hub](https://www.npmjs.org/package/@scramjet/sth). The package holds the typescript definitions for all common STH interfaces.
