# `@scramjet/model` <!-- omit in toc -->

The package provides the domain model for Scramjet Transform Hub, the API Client and CLI.

## Docs

See the code documentation here: [scramjetorg/transform-hub/docs/model/README.md](https://github.com/scramjetorg/transform-hub/tree/HEAD/docs/model/README.md)
