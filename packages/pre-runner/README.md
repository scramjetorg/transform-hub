...
This package is part of [Scramjet Transform Hub](https://www.npmjs.org/package/@scramjet/sth). The package identifies the sequences and returns the information to back STH.
