...
4. On dispatch, the instance adapter calculates runner image from `engines` using `selectRuntimeKind`, checks quotas, creates pod spec, sets env/labels/commands, and applies resource limits.
