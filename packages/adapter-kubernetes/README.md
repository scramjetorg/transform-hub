...
* [DockerSequenceAdapter](https://github.com/scramjetorg/transform-hub/tree/HEAD/packages/adapter-kubernetes/src/kubernetes-sequence-adapter.ts) - An adapter for preparing Sequence to be run in Kubernetes container.
* [DockerInstanceAdapter](https://github.com/scramjetorg/transform-hub/tree/HEAD/packages/adapter-kubernetes/src/kubernetes-instance-adapter.ts) - An adapter for running Instance by Runner executed in Kubernetes container.

## Docs

See the code documentation here: [scramjetorg/transform-hub/docs/adapters-kubernetes/modules.md](https://github.com/scramjetorg/transform-hub/tree/HEAD/docs/adapters-kubernetes/modules.md)
