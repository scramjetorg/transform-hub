# `@scramjet/supervisor` <!-- omit in toc -->

This package executes the remote runners and provides communication with them through abstraction layer provided by adapters.

## Docs

See the code documentation here: [scramjetorg/transform-hub/docs/supervisor/README.md](https://github.com/scramjetorg/transform-hub/tree/HEAD/docs/supervisor/README.md)
