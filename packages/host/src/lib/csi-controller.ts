...
import { mapRunnerExitCode, RunnerExitCodeDef } from "./utils";
...
export class CSIController extends TypedEmitter<Events> {
    ...
    private mapRunnerExitCode(exitcode: number): Promise<RunnerExitCodeDef> {
        return mapRunnerExitCode(exitcode);
    }
