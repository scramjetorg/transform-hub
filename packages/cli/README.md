...
This package is part of [Scramjet Transform Hub](https://www.npmjs.org/package/@scramjet/sth). The package provides a CLI interface to communicate with Scramjet Transform Hub.
