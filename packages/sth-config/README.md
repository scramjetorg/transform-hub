...
This package executes the sequences and controls the runner via the wired adapter.

## Docs

See the code documentation here: [scramjetorg/transform-hub/docs/sth-config/README.md](https://github.com/scramjetorg/transform-hub/tree/HEAD/docs/sth-config/README.md)
