...
test("imageConfig has expected image tags", t => {
    t.is(imageConfig.prerunner, "scramjetorg/pre-runner:2.1.1-devel");
    t.is(imageConfig.runner.node, "scramjetorg/runner:2.1.1-devel");
    t.is(imageConfig.runner.python3, "scramjetorg/runner-py:2.1.1-devel");
    t.is(imageConfig.runner.bun, "scramjetorg/runner-bun:2.1.1-devel");
});
