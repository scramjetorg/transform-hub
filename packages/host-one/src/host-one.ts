...
export class HostOne implements IComponent {
    ...
    async createApiServer(): Promise<void> {
        ...
        // operations
        this.api.op("post", `${apiBase}/sequence/_monitoring_rate/`, RunnerMessageCode.MONITORING_RATE, this.communicationHandler);
        this.api.op("post", `${apiBase}/sequence/_event/`, RunnerMessageCode.EVENT, this.communicationHandler);
        this.api.op("post", `${apiBase}/sequence/_stop/`, RunnerMessageCode.STOP, this.communicationHandler);
        this.api.op("post", `${apiBase}/sequence/_kill/`, RunnerMessageCode.KILL, this.communicationHandler);
