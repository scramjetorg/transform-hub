...
See the code documentation here: [scramjetorg/transform-hub/docs/logger/README.md](https://github.com/scramjetorg/transform-hub/tree/HEAD/docs/logger/README.md)
