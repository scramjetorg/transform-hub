...
> **Note**: This page documents the **v1 API** surface used by `@scramjet/api-client` and the `/api/v1` route tree. The v1 API remains available and supported for backwards compatibility. New projects should use the **v2 API** surface (see [API client usage](../../../../content/api/client-usage.md)).
...
The v1 API remains supported for existing deployments. New projects should use the v2 API via `@scramjet/rest-api2`. See the [API client usage](../../../../content/api/client-usage.md) page for v2 documentation.

### See also

- [API client usage (v2)](../../../../content/api/client-usage.md) — current v2 API client documentation
- [CLI usage](../../../../content/cli/usage.md) — command-line interaction
- [Transform Hub core concepts](../../../../content/transform-hub/core-concepts.md) — architecture context
