...
- **No REQUESTS/BPMux for Python**: Unlike the Node wrapper, the Python runner does not use the BPMux REQUESTS channel. Control and data flow exclusively through the dedicated fd4/fd5 pipes.
