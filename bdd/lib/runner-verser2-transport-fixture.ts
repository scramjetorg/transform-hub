...
const { RunnerVerser2Transport } = publishedModule<{ RunnerVerser2Transport: any }>("@scramjet/runner");

type RunnerVerser2TransportInstance = any;
...
export function createRunnerVerser2TransportFixture(
    ...
    const state: {
        host?: VerserHost;
        broker?: VerserBroker;
        transport?: RunnerVerser2TransportInstance;
