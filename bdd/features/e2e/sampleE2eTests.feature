Feature: Sample e2e tests
    ...
    Scenario: TC_003 Send test-event through API and get event emitted by sequence
    ...
    Scenario: TC_002 Kill sequence - kill handler should emit event when executed
