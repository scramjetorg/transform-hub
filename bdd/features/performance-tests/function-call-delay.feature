Feature: Verify delay
    ...
    Scenario: Verify delay
        Given host one execute sequence "../packages/reference-apps/inert-sequence-2-with-delay.tar.gz" with arguments "4000" and redirects output to "delay.test.result.txt"
