Feature: Verify delay
    ...
    Scenario: Verify delay
        ...
        And calculate avereage delay time of first "2000" function calls starting "2000"
    ...
    #     When file "delay.test.result.txt" is generated
    #     And calculate avereage delay time of first "10000" function calls starting "2000"
    #     Then calculated avereage delay time is lower than "100000" ns
